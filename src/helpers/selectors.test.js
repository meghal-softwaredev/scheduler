...
//State of application for testing
const state = {
  days: [
    {
      id: 1,
...
//test getAppointmentsForDay() - should return an array
test("getAppointmentsForDay returns an array", () => {
  const result = getAppointmentsForDay(state, "Monday");
  expect(Array.isArray(result)).toBe(true);
});

//test getAppointmentsForDay() - should return length of number of appointments for day
test("getAppointmentsForDay returns an array with a length matching the number of appointments for that day", () => {
  const result = getAppointmentsForDay(state, "Monday");
  expect(result.length).toEqual(3);
});

//test getAppointmentsForDay() - return correct appointment object
...
//test getAppointmentsForDay() - returns [] if days data is empty
...
//test getAppointmentsForDay() - return [] if day is not found
...
// Test for getInterview() ends

// Test for getInterviewersForDay() starts
...
// Test for getInterviewersForDay() ends