...
//Checks DayListItem component in isolation
  ...
  .add("Clickable", () => (
    <DayListItem name="Tuesday" onChange={() => action("setDay")("Tuesday")} spots={5} /> 
  ));
...
storiesOf("Appointment", module)
  ...
  .add("Edit", () => <Form student="Bob" interviewer={1} interviewers={interviewers} onSave={action("onSave")(student, interviewer)} onCancel={action("onCancel")} />)
